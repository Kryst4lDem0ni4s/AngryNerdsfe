...
class SyncOrdersPage extends StatelessWidget {
  const SyncOrdersPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Sync Your Offline Order Updates',
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                // Logic to sync offline order updates
              },
